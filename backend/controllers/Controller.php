...
/**
 * Base backend controller component
...
class Controller extends \yii\web\Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        if(Yii::$app->user->isGuest){
          ...
          Yii::$app->getResponse()->redirect(['/sign/in'])->send();
          return false;
        } else {
          /*
    ...
    {
      return Yii::$app->getSession()->get($this->module->id.'_return', $defaultUrl ? Url::to($defaultUrl) : Url::to('/'.$this->module->id));
    }
